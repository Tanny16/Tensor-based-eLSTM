...
class RConvLSTM2DCell(Layer):
    ...
    def __init__(self, filters,
                 ...
                 recurrent_dropout=0.,
                 **kwargs):
        super(RConvLSTM2DCell, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        self.cell_kernel_rt = self.add_weight(shape=self.kernel_size + (5, self.filters),
                                      initializer=self.kernel_initializer,
                                      name='kernel',
                                      regularizer=self.kernel_regularizer,
                                      constraint=self.kernel_constraint)
        self.cell_kernel_rs = self.add_weight(shape=self.kernel_size + (1, self.filters),
                                      initializer=self.kernel_initializer,
                                      name='kernel',
                                      regularizer=self.kernel_regularizer,
                                      constraint=self.kernel_constraint)
    ...
    def call(self, inputs, states, training=None):
        ...
        c_r = self.activation(self.input_conv(c, self.cell_kernel_rt, self.bias_i, padding=self.padding))
        print(inputs_i)
        print(self.cell_kernel_rs)
        c_f = c - c_r + c_r * self.recurrent_activation(self.input_conv(inputs, self.cell_kernel_rs,
                                                                        self.bias_i, padding=self.padding))
        o = self.recurrent_activation(x_o + h_o)
        h = o * self.activation(c_f)
    ...
    def get_config(self):
        ...
        base_config = super(RConvLSTM2DCell, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))


class RConvLSTM2D(ConvRNN2D):
    """Convolutional LSTM.
    ...
    def __init__(self, filters,
                 ...
                 recurrent_dropout=0.,
                 **kwargs):
        cell = RConvLSTM2DCell(filters=filters,
        ...
        super(RConvLSTM2D, self).__init__(cell,
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        return super(RConvLSTM2D, self).call(inputs,
                                            mask=mask,
                                            training=training,
    ...
    def get_config(self):
        config = {'filters': self.filters,
                  ...
                  'dropout': self.dropout,
                  'recurrent_dropout': self.recurrent_dropout}
        base_config = super(RConvLSTM2D, self).get_config()
