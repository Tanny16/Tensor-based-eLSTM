...
class RLSTMCell(Layer):
    ...
    def build(self, input_shape):
        ...
        self.cell_kernel_rt = self.add_weight(
            shape=(self.units, self.units),
            name='cell_kernel',
            initializer=self.kernel_initializer,
            regularizer=self.kernel_regularizer,
            constraint=self.kernel_constraint)
        self.cell_kernel_rs = self.add_weight(
            shape=(6, self.units),
            name='cell_kernel',
            initializer=self.kernel_initializer,
            regularizer=self.kernel_regularizer,
    ...
    def call(self, inputs, states, training=None):
        ...
        if self.implementation == 1:
            ...
            c_r = self.activation(K.dot(c, self.cell_kernel_rt))

            c_f = c - c_r + c_r * self.recurrent_activation(K.dot(inputs_i[:, -6:], self.cell_kernel_rs))
            ...
            c_f = f * c_tm1 + i * self.activation(z2)
